...
\begin{document}
	...
	% Textuais
		...
		% NOTA:
		% No template do IMECC, a introdução não é enumerada e a divisão é feita em parts, chapters, sections, subsections e subsubsections.
		% Neste template a introdução é o ``capítulo 1'' e eu usei chapters ao invés de parts. Isso deixa o documento um pouco mais simples e o índice fica mais fácil de ler.
		% Discuta com o seu orientador qual caminho seguir!
