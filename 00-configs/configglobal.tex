...
% Novos comandos e ambientes
	...
	\newcommand{\citep}{\citeonline} % Na minha dissertação usei o padrão de referências Nome Do Fulano (1999). Com esse ajuste você pode usar só o \citep{apelido_do_artigo}
